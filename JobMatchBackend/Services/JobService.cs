...
public class JobService : IJobService
{
    ...
    public async Task<JobDetailResponse> UpdateJobAsync(int jobId, Guid companyId, UpdateJobRequest request)
    {
        ...
        var isAutonomous = string.Equals(updated.Type, "autonomous", StringComparison.OrdinalIgnoreCase);
        ...
        return new JobDetailResponse
        {
            ...
            WorkDate = isAutonomous ? null : updated.WorkDate,
            StartTime = isAutonomous ? null : updated.StartTime,
            EndTime = isAutonomous ? null : updated.EndTime,
